package net.copralianetwork.copralia.Utils.Slider;
 ...
 */
public class SliderIndicator extends View implements PageIndicator {
    ...
    public SliderIndicator(Context context, AttributeSet attrs, int defStyle) {
